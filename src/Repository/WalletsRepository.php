...
class WalletsRepository extends ServiceEntityRepository
{
    ...
    public function findOneByCharCode($value): ?Wallets {
        return $this->createQueryBuilder('w')
            ->andWhere('w.CharCode = :val')
            ->setParameter('val', $value)
            ->getQuery()
    ...
    public function findAllWalletsCharCodeAndId() {
        return $this->createQueryBuilder('w')
            ->select(array('w.id','w.CharCode'))
            ->getQuery()
            ->getResult();
    }
    ...
    public function truncate():void {
        ...
        $connection->executeUpdate($platform->getTruncateTableSQL('wallets',false));
    }
